...
//        checkingShoppingCart();
    ...
    public static int sum(int a, int b) {
        assert (Integer.MAX_VALUE - a >= b) : "Заданное число превышает максимальное значение";
        return a + b;
    }
    ...
    public static void happyNY() {
        ...
        assert currentDateTime.compareTo("01/01/2023 00:00:00") > 0 : "Еще 2022 год :(";
        assert currentDateTime.compareTo("01/01/2023 00:00:00") < 0 : "Уже 2023 год :)";
    ...
    public static void checkingHero(Hero hero) {
        ...
        */
        ...
        assertEquals(hero.getName(), "Emmett");
        assertEquals(hero.getArmorStrength(), 50);
        assertEquals(hero.getWeapon(), "sword");
